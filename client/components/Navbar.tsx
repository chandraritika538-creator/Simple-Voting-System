    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-3">
          <div className="relative flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[#7c6cf0] to-[#34d399] shadow-[0_0_20px_rgba(124,108,240,0.3)]">
        ...
        <div className="flex items-center gap-3">
          ...
          {walletAddress ? (
            ...
            >
              <div className="h-6 w-6 rounded-full bg-gradient-to-br from-[#7c6cf0] to-[#34d399] p-[1.5px]">
