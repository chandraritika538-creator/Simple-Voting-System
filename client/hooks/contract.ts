...
export const CONTRACT_ADDRESS =
  "CCO6HUWX5VITTVRJTN3SHZ3FEGAYV2J4X4NCTINVPGEPUZ2AMNYH47N2";
...
// ============================================================
// Simple Voting System — Contract Methods
// ============================================================
 ...
 * Calls: init()
 */
export async function initVoting(caller: string) {
  return callContract("init", [], caller, true);
}

/**
 * Cast a vote for a candidate.
 * Calls: vote(voter: Address, candidate: String)
 */
export async function vote(caller: string, candidate: string) {
  return callContract(
    "vote",
    [toScValAddress(caller), toScValString(candidate)],
    caller,
    true
  );
}
 ...
 * Calls: get_votes(candidate: String) -> u32
 */
export async function getVotes(candidate: string, caller?: string) {
  return readContract(
    "get_votes",
...
/**
 * Get all votes (read-only).
 * Calls: get_all_votes() -> Map<String, u32>
 */
export async function getAllVotes(caller?: string) {
  return readContract("get_all_votes", [], caller);
}
